...
# MAGIC
# MAGIC 1. Ler uma origem Kafka e gravar 1:1
...
def kafka_to_bronze_single():
    ...
    query = (spark
            ...
            .writeStream
                ...
                .trigger(availableNow=True) #Trigger availableNow=True realiza o processamento em batch
...
kafka_to_bronze_single()

# COMMAND ----------

# MAGIC %sql
# MAGIC select count(1)
# MAGIC from bronze.gcn.heartbeat