...
docker exec -it spark-master /opt/bitnami/spark/bin/spark-submit \
  ...
  --deploy-mode client \
  /opt/bitnami/spark/jobs/app/mod-2-pr-17.py
"""
...
spark.sql("""SELECT * FROM driver_shifts""").show(truncate=False)
...
# TODO haverside distance calculations circle distance between two points on the surface of a sphere
...
spark.sql("""
    SELECT
          ...
          PERCENTILE(average_rating, 0.5) as p50_rating,
...
# TODO distribution functions with CUME_DIST and PERCENT_RANK
...
SELECT
    ...
    ROUND(r.average_rating - cs.mean_rating, 2) as z_score
FROM restaurants r
