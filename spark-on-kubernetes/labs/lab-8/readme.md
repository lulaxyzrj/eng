...
kubectl apply-f labs/lab-8/scripts/spark-application1.yaml -n processing

kubectl apply -f labs/lab-8/scripts/spark-application2.yaml -n processing

kubectl apply -f labs/lab-8/scripts/spark-application3.yaml -n processing
```
