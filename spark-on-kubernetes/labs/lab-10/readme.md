...
#         kubectl create secret generic git-creds   --from-file=ssh=/home/lulax/.ssh/id_ed25519   --from-file=known_hosts=/home/lulax/.ssh/known_hosts   --dry-run=client -o yaml
