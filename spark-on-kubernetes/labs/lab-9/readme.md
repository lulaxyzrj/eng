...
```sh
kubectl apply -f labs/lab-9/scripts/secret-credential.yaml -n processing

kubectl apply -f labs/lab-9/scripts/service-metrics.yaml -n processing

kubectl apply -f labs/lab-9/scripts/spark-application1.yaml -n processing

kubectl apply -f labs/lab-9/scripts/spark-application2.yaml -n processing
```
